...
if (dist == 'poisson') {
  readRDS(paste('../Models/GLAR_Pois/model_', resp, '.rds', sep = '')) %>% 
    plot()
} else {
  readRDS(paste('../Models/GLAR_NBinom/model_', resp, '.rds', sep = '')) %>% 
    plot()
}

if (dist == 'poisson') {
  predictors <- readRDS('../Optimize/GLAR_Pois/predictors.RData')
  tuned <- readRDS('../Optimize/GLAR_Pois/tuned.RData')
} else {
  predictors <- readRDS('../Optimize/GLAR_NBinom/predictors.RData')
  tuned <- readRDS('../Optimize/GLAR_NBinom/tuned.RData')
}
