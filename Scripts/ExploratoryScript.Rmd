...
Questions for Gray:  
- Should predictions be rounded since we're dealing a discrete domain?  
- How should NA values be handled? Is it safe to convert them to zeros if I notice structural patterns in the NAs?  
- Help understanding stationarity.  
- What are the other coefficients at the bottom of the INAR model summary?  
