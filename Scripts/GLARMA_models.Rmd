...
var_select_aics %>%
  saveRDS('../Optimize/GLARMA_Pois/varSelectAIC.RData')

model_tune_aics %>%
  saveRDS('../Optimize/GLARMA_Pois/modelTuneAIC.RData')
```
...
var_select_aics %>%
  saveRDS('../Optimize/GLARMA_NBinom/varSelectAIC.RData')

model_tune_aics %>%
  saveRDS('../Optimize/GLARMA_NBinom/modelTuneAIC.RData')
```
